...
async def unload_model(request: Request, form_data: ModelUnloadForm, user=Depends(get_admin_user)):
    ...
    Supports OpenAI-compatible providers that expose a native unload endpoint,
    such as llama.cpp (`/models/unload`).
    """
...
async def embeddings(request: Request, form_data: dict, user=Depends(get_verified_user)):
    ...
    This handler:
      ...
      - Supports OpenAI-compatible providers, pipelines, and other retained providers.
